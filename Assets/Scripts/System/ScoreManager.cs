...
public class ScoreManager : MonoBehaviour
{
    ...
    //        score += currentMultiplier; // Lisää pistemäärää kertoimen mukaan
    //        scoreTextObject.text = $"Score: {score}"; // Päivitä teksti näyttämään nykyinen pistemäärä

    //        yield return new WaitForSeconds(0.5f); // Odota 0.5 sekuntia ennen seuraavaa päivitystä
    //    }
    //}
    //public void SetScoreMultiplier(int multiplier)
    //{
    //    scoreMultiplier = Mathf.Max(1, multiplier); // Varmistetaan, että kerroin on vähintään 1
    //}
